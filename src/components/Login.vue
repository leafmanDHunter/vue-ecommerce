      ...
      <div class="modal-body">
        ...
        <!--Login Form Details -->
            ...
            <div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" v-on:click="register">Signup</button>
                </div>
...
export default {
   ...
   methods: {
       ...
       register: function() {
           ...
           .then((user) => {
               //Hide Modal before redirecting user to admin panel.
            $('#login').modal('hide')
               //Note that $router is an instance of Vue Router.
               // After successful registration. Create User Profile, with their User ID.
               //Set the ID off this collection to user ID. user.user.id
           ...
           .catch(function(error) {
            ...
            if(errorMessage){
                //Log the error message being received.
